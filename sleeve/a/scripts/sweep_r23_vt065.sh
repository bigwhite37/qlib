#!/usr/bin/env bash
# Round-23, step 5: the best CAGR that still reliably clears the 10% volatility
# ceiling.  h120 (vol-target 0.055, 120-day hold) landed at 9.65% volatility with
# 9/9 seeds under the ceiling; this raises the target one notch to use the
# remaining headroom.
set -u
...
for S in 42 7 2024 11 23 101 777 31337 5; do
  ...
  run v2_h_vt065_$S $P9 "$BASE --vol-target 0.065"
done
echo ALLDONE
